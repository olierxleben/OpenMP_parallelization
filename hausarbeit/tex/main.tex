...
Ein team of threads wird mittels \textit{\#pragma omp parallel} gestartet. Zur Veranschaulichung sei folgendes Beispiel gegeben: 

\lstinputlisting[caption=parallel, label=Beispiel Parallel]{../src/1_3_example/parallel.c}
