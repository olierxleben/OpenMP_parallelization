...
% TODO: Unnötige Texte für die final rausnehmen
...
% TODO/Vorschlag: Einsatz von MPI in verteilten Anwendungen mit aufnehmen? 
...
\subsection{Parallele Schleifen - Hello World}
...
\subsection{Parallele Schleifen - Hello World 2}
...
\subsection{Task-Beispiel: Fibunacci}
\lstinputlisting[caption= Task-Beispiel: Fibunacci, label=taskExample]{../src/tasks/fib.c}
% TODO: Erklärung
\end{document}
